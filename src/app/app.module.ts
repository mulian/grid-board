...
@NgModule({
    declarations: [
        ...
        SettingsSlideComponent,
        SettingsHistoryComponent,
        SettingsKeyboardComponent,
        SettingsJsinjectionsComponent,
    ],
    imports: [
        ScrollingModule,
        MatTableModule,
    ...
    entryComponents: [HelpComponent, DialogSettingsComponent],
