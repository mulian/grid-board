...
import { DialogModel, DialogType, CloseDialog as CloseDialog } from '../states/dialog';
import { selectDialogAll } from '../states/dialog'
import { MatDialog, MatDialogRef } from '@angular/material/dialog';
import { HelpComponent } from './help/help.component'
import { ComponentType } from '@angular/cdk/portal';
import { GridItemComponent } from '../content/grid-item/grid-item.component';
import { DialogSettingsComponent } from './dialog-settings/dialog-settings.component';
import { dialogInitialState } from '../states/dialog/dialog.initial.state'
...
export class DialogService {
  ...
  getComponent(dialogType: DialogType):ComponentType<unknown> {
    switch(dialogType) {
      case DialogType.HELP: return HelpComponent
      case DialogType.SETTINGS: return DialogSettingsComponent
      default: return null;
    }
  }
